 ...
 */
 ...
 const books = [
  ...
  // TODO
  let greatAuthors = books.filter((item) => item.sales > 1000000);
  greatAuthors = greatAuthors.map((item) => {return `${item.author} adalah penulis buku ${item.title} yang sangat hebat!`})
